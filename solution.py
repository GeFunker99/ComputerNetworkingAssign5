...
def build_packet():
    ...
    mypacketID = os.getpid() & 0xFFFF
    # Make the header in a similar way to the ping exercise.
    checksum = 0
    header = struct.pack("bbHHh", ICMP_ECHO_REQUEST, 0, checksum, mypacketID, 1)
    ...
    for ttl in range(1,MAX_HOPS):
        for tries in range(TRIES):
            ...
            try:
                ...
                type, code, checksum, mypacketID, sequence = struct.unpack("bbHHh", icmpHeader)
